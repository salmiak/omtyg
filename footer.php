  ...
  <?php if(is_front_page()) { ?>
    <script src="<?php bloginfo('template_url'); ?>/libs/jquery.endless-scroll.js" charset="utf-8"></script>
    <script src="<?php bloginfo('template_url'); ?>/js/frontpage.js" charset="utf-8"></script>
  <?php } ?>
